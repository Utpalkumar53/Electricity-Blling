...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String atype,String meter){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/elect3.jpg"));
        ...
        JMenuItem depositdetails = new JMenuItem("Diposit Details");
        ...
        ImageIcon icon8 = new ImageIcon(ClassLoader.getSystemResource("icon/icons8.png"));
        Image image8 = icon8.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
        billdetail.setIcon(new ImageIcon(image8));
        billdetail.setMnemonic('S');
        billdetail.addActionListener(this);
        billdetail.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S,ActionEvent.CTRL_MASK));
        user.add( billdetail);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (msg.equals("New Customer")){
            ...
            new CustomerDetails();
        }else if (msg.equals("Diposit Details")){
            new DepositDetails();
