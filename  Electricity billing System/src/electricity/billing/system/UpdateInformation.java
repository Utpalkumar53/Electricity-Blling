...
public class UpdateInformation extends JFrame implements ActionListener{
    ...
    UpdateInformation(String meter){
        ...
        JLabel heading = new JLabel("UPDATE CUSTOMER INFORMATRION");
    ...
    public void actionPerformed(ActionEvent ae){
       if (ae.getSource() == update){
          ...
          try{
              Conn c = new Conn();
                c.s.executeUpdate("update customer SET address = '"+address+"', state = '"+state+"', city = '"+city+"', email = '"+email+"', phone = '"+phone+"' where meter_no = '" +meter+"'");
