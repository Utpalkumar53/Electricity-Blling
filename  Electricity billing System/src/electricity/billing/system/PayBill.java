...
public class PayBill extends JFrame implements ActionListener{
    ...
    PayBill(String meter){
            ...
            meternumber.setFont(new Font("Tahoma", Font.BOLD,24));
            ...
            lblmonth.setFont(new Font("Tahoma", Font.BOLD,24));
            ...
            lblunits.setFont(new Font("Tahoma", Font.BOLD,24));
            lblunits.setBounds(35,260,200,20);
            add(lblunits);
            
            JLabel labelunits = new JLabel("");
            labelunits.setFont(new Font("Tahoma", Font.BOLD,24));
            labelunits.setBounds(300,260,200,20);
            add(labelunits);
            
            JLabel lbltotalbill = new JLabel("Total Bill");
            lbltotalbill.setFont(new Font("Tahoma", Font.BOLD,24));
            lbltotalbill.setBounds(35,320,200,20);
            add(lbltotalbill);
            
            JLabel labeltotalbill = new JLabel("");
            labeltotalbill.setFont(new Font("Tahoma", Font.BOLD,24));
            ...
            labelstatus.setFont(new Font("Tahoma", Font.BOLD,24));
            ...
            try{
                ...
                while(rs.next()){
                    labelunits.setText(rs.getString("unit"));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == pay) {
            try{
                Conn c = new Conn();
                c.s.executeUpdate("update bill set status = 'Paid' where meter_no = '"+meter+"' AND month= '"+cmonth.getSelectedIndex()+"'");
